...
import { adminSigninReducer, coverListReducer, createStoreCoverReducer, createStoreReducer, deleteStoreCoverReducer, storeListReducer, storeSigninReducer } from '../reducers/adminReducer.js';
const initialState = {
    adminSignin: {
