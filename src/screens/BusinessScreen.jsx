    ...
    return (
        ...
        <div className={openModal? "modalStore active" : "modalStore"}>
            <div>
                {barSelected? (
                    <span>
                    {errorSignin? errorSignin : barSelected.name}
                </span>
                ): (
                    <h2>NO BAR</h2>
                )}
            ...
            <input type="password" value={password}  onChange={(e) => setPassword(e.target.value)} placeholder='Ingrese la contrasena del negocio'/>
